...
<section class="section">
  ...
  <article class="project-card">
    ...
    <div>
      ...
      <p><a href="https://pubs.acs.org/doi/10.1021/acs.jpcc.3c06455" target="_blank" rel="noopener">Paper 1</a> | <a href="https://pubs.acs.org/doi/full/10.1021/acs.chemmater.4c01192" target="_blank" rel="noopener">Paper 2</a></p>
    </div>
  </article>

  <article class="project-card">
    <img src="{{ '/assets/SiGA.jpg' | relative_url }}" alt="General Atomics internship">
    <div>
  ...
  <article class="project-card">
    ...
    <div>
      <h3>Fusion Energy Modeling at Princeton Plasma Physics Laboratory</h3>
      <p>At Princeton Plasma Physics Laboratory, I modeled heat extraction using Ansys Fluent CFD and compared thermodynamic cycle efficiency for future fusion plants.</p>
    </div>
  </article>
